...
parser.add_argument('--num_iters', type=int, default=400, help='number of iterations of Lucas-Kanade')  # default=1e3
parser.add_argument('--threshold', type=float, default=1e-2, help='dp threshold of Lucas-Kanade for terminating optimization')
parser.add_argument('--tolerance', type=float, default=0.2, help='binary threshold of intensity difference when computing the mask')   # default=0.2
